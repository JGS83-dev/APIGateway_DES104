...
namespace APIAuth.Services
{
    ...
    {
        new("admin", "aDm1n", "Administrator", new[] {"weather.read"}),
        new("user01", "u$3r01", "User", new[] {"weather.read"})
    };

        public AuthenticatedResponse? GenerateAuthToken(LoginModel loginModel)
        {
